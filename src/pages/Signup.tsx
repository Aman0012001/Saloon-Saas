    ...
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-4 py-12">
      <Card className="w-full max-w-xl border-none shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] bg-white rounded-[3rem] overflow-hidden">
        <CardHeader className="text-center pt-12 pb-8">
          ...
          <CardTitle className="text-4xl font-black text-slate-900 tracking-tight">Saloon Partner Enrollment</CardTitle>
          <CardDescription className="font-bold text-slate-400 mt-2">Initialize your local management node</CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-6 px-0">
            ...
            <div className="flex items-center gap-4 p-6 bg-slate-900 rounded-[2rem] mb-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Exclusive Saloon Owner access</p>
              </div>
            </div>
